"""
Django settings for myBroadcastingApp project.
...
SECRET_KEY = 'django-insecure-+)ajc#gue2b0ok02f@)vvs!$l%y3qqje&sy2+fiu646bvsoi$*'
...
ROOT_URLCONF = 'myBroadcastingApp.urls'
...
WSGI_APPLICATION = 'myBroadcastingApp.wsgi.application'
